...
##### Not done #####
I had many troubles while doing the project and I got not enough time to get some things done:

* Image for scoops.
* Push notification when updating a scoop.
* Scheduled job to change a scoop from "InReview" to "Published" status.
* Analytics.